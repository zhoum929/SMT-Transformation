...
void input_SOL(){
	...
	/*if(feas){
		...
		if(sol_num==1){
			...
			if(objsense=="min")fout<<to_real(lb)<<"))"<<endl;
			...
			for(int j=0;j<sol_num;j++){
				...
				if(objsense=="min")fout<<to_real(lb)<<")";
